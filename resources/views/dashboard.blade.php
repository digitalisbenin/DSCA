                            ...
                            <div class="card border border-gray-100">
                                <div class="card-body p-8">
                                    ...
                                    <div class="p-8">
                                        ...
                                        <div class="flex-align gap-8 flex-wrap mt-16">
                                            <img src="admin/assets/images/thumbs/user-img5.png" class="w-28 h-28 rounded-circle object-fit-cover" alt="User Image">
                                            <div>
                            ...
                            <div class="card border border-gray-100">
                                <div class="card-body p-8">
                                    ...
                                    <div class="p-8">
                                        ...
                                        <div class="flex-align gap-8 flex-wrap mt-16">
                                            <img src="admin/assets/images/thumbs/user-img6.png" class="w-28 h-28 rounded-circle object-fit-cover" alt="User Image">
                                            <div>
                                                <span class="text-gray-600 text-13">Created by <a href="profile.html" class="fw-semibold text-gray-700 hover-text-main-600 hover-text-decoration-underline">Albert James</a> </span>
                                            </div>
                                        </div>
