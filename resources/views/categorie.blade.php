        ...
        <div class="single-head" >
            ...
            <div class="mb-3" >
                <ul class="list-unstyled d-flex flex-wrap gap-2">
                    ...
                    <li>
                        <a href="{{ url('/categorie/'.$id) }}#filtre" class="btn btn-primary">
                            Toutes les difficultés
                        </a>
                    </li>
                    @foreach($difficultes as $difficulte)
                        <li>
                            <a href="{{ url('/categorie/'.$id.'?difficulte_id='.$difficulte->id) }}#filtre" 
               ...
               <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-course wow fadeInUp" data-wow-delay=".2s">
                    <div class="course-image" style="height: 200px">
                        <a href="{{url('module-details/'.$value->id)}}"><img src="{{ asset('assets/uploads/formation_images/'.$value->image_url) }}"
