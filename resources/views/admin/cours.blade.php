    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-24 flex-between gap-16 flex-wrap-reverse">
                ...
                <a href="create-course.html" class="btn btn-main rounded-pill py-7 flex-align gap-4 fw-normal">
                            ...
                            <div class="card border border-gray-100">
                                <div class="card-body p-8">
                                    ...
                                    <div class="p-8">
                                        ...
                                        <a href="course-details.html" class="btn btn-outline-main rounded-pill py-9 w-100 mt-24">Continue Classes</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card border border-gray-100">
                        <div class="card-body p-8">
                            ...
                            <div class="p-8">
                                ...
                                <a href="course-details.html" class="btn btn-outline-main rounded-pill py-9 w-100 mt-24">Start The Mentoring</a>
                            </div>
                        </div>
                    </div>
                </div>
