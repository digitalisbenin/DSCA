...
<li><span class="text-main-600 fw-normal text-15">Créer une Visio conférences</span></li>
</ul>
</div>
<!-- Breadcrumb End -->
...
<!-- Create Course Step List End -->
    ...
    <div class="card">
        <div class="card-header border-bottom border-gray-100 flex-align gap-8">
            <h5 class="mb-0">Visio Conférence</h5>
            <button type="button" class="text-main-600 text-md d-flex" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Visio Conférence">
                <i class="ph-fill ph-question"></i>
            </button>
        </div>
        <div class="card-body">
            <form action="{{ url('visio-conferences') }}" method="post" enctype="multipart/form-data">
                        @csrf
                <div class="row gy-20">
