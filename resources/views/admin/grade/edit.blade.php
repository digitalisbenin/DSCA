...
<!-- Create Course Step List End -->
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('user-categories/' . $userCategory->id.'/update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                <div class="row gy-20">
...
>>>>>>> 758af20ded3cd43b4cd55039958b1f3c10f229d7
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="text-counte placeholder-13 form-control py-11 pe-76" name="description"value="{{ old('description', $userCategory->description) }}"  maxlength="500" id="courseTitle" placeholder="">
                                    <div class="text-gray-400 position-absolute inset-inline-end-0 top-50 translate-middle-y me-16">
