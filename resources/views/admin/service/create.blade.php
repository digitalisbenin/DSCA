...
<li><span class="text-main-600 fw-normal text-15">Créer un service</span></li>
</ul>
</div>
<!-- Breadcrumb End -->
        ...
        <div class="card-body">
            <form action="{{ url('services') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row gy-20">
                    ...
                    <div class="flex-align justify-content-end gap-8">
                        <a href="{{url('create-services')}}" class="btn btn-outline-main rounded-pill py-9">Annuler</a>
