...
<li><span class="text-main-600 fw-normal text-15">Modifier un quiz</span></li>
</ul>
</div>
<!-- Breadcrumb End -->
...
<!-- Create Course Step List End -->
    ...
    <div class="card">
        <div class="card-header border-bottom border-gray-100 flex-align gap-8">
            <h5 class="mb-0">Modifier un Quizz</h5>        
            <button type="button" class="text-main-600 text-md d-flex" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Modifier un Quizz">
                <i class="ph-fill ph-question"></i>
            </button>
        </div>
        <div class="card-body">
            <form action="{{ url('quizs/'.$quiz->id.'/update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                <div class="row gy-20">
