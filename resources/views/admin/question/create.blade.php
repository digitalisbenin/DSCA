...
<li><span class="text-main-600 fw-normal text-15">Créer une Question</span></li>
</ul>
</div>
<!-- Breadcrumb End -->
                ...
                <div class="row gy-20">
                    ...
                    <div class="col-xxl-12 col-md-12 col-sm-7">
                        <div class="row g-20 mb-6">
                            <div class="col-sm-6">
                                <label for="courseTitle" class="h5 mb-8 fw-semibold font-heading">Question <span class="text-13 text-gray-400 fw-medium">(*)</span> </label>
                            ...
                            <div class="col-sm-6">
                                <label for="courseCategory" class="h5 mb-8 fw-semibold font-heading">Quizz <span class="text-13 text-gray-400 fw-medium">(*)</span></label>
                                <div class="position-relative">
                    ...
                    <div class="flex-align justify-content-end gap-8">
                        <a href="{{url('create-question')}}" class="btn btn-outline-main rounded-pill py-9">Annuler</a>
