...
<li><span class="text-main-600 fw-normal text-15">Créer une Class</span></li>
</ul>
</div>
<!-- Breadcrumb End -->
...
<!-- Create Course Step List End -->
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('class') }}" method="post" enctype="multipart/form-data">
                        @csrf
                <div class="row gy-20">
                    ...
                    <div class="flex-align justify-content-end gap-8">
                        <a href="{{url('create-difficultes')}}" class="btn btn-outline-main rounded-pill py-9">Annuler</a>
