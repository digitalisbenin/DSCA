    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                ...
                <li><span class="text-main-600 fw-normal text-15">Poste</span></li>
            </ul>
        </div>
                    <!-- Breadcrumb End -->
        ...
        <div class="card-body p-0 overflow-x-auto">
            <div class="card">
                <div class="card-header border-bottom border-gray-100 flex-align gap-8">
                    <h5 class="mb-0">Nouveau Poste</h5>
            ...
            <div class="card-body">
                <form action="{{ url('postes') }}" method="post" enctype="multipart/form-data">
                            @csrf
                    <div class="row gy-20">
                        ...
                        <div class="col-xxl-12 col-md-12 col-sm-7">
                            <div class="row g-20">
                                <div class="col-sm-12">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="text-counter placeholder-13 form-control py-11 pe-77" name="name" maxlength="100" id="courseTitle" placeholder="">
                                        <div class="text-gray-400 position-absolute inset-inline-end-0 top-50 translate-middle-y me-16">
                                            <span id="current">3</span>
                                            <span id="maximum">/ 100</span>
                                        </div>
                                ...
                                <div class="col-sm-6" style="display: none;">
                                    <label for="courseCategory" class="h5 mb-8 fw-semibold font-heading">Services <span class="text-13 text-gray-400 fw-medium">(*)</span></label>
                                    <div class="position-relative">
                                           ...
                                           <input type="text" class="form-control py-9 placeholder-13 text-15" disabled name="" value="{{ $services->first()->name ?? '' }} ">
                                           @endforeach
                                 ...
                                 <div class="col-sm-12">
                                    ...
                                    <div class="position-relative">
                                        <textarea type="text" class="text-counte placeholder-13 form-control py-11 pe-76" name="description"  id="course" placeholder=""></textarea>
            ...
            <table id="studentTable" class="table table-striped">
                <thead>
                    <tr class="">
                        ...
                        <th class="h6 text-gray-300">Service</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="h6 mb-0 fw-medium text-gray-300">{{$value->description}}</span>
                        </td>
                        ...
                        <td>
                           ...
                           <a href="{{url('postes/'.$value->id.'/edit')}}" class="bg-success-600 text-white py-2 px-14 rounded-pill hover-bg-success-800 hover-text-white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                          </svg></a>
                        <a href="{{url('postes/'.$value->id.'/destroy')}}" class="bg-danger-600 text-white py-2 px-14 rounded-pill hover-bg-danger-800 hover-text-white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
