...
<!-- Create Course Step List End -->
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('reponses/' . $reponse->id.'/update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                <div class="row gy-20">
                        ...
                        <div class="row g-20 mb-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="text-counter placeholder-13 form-control py-11 pe-76" name="title"value="{{ old('title', $reponse->title) }}"  maxlength="200" id="courseTitle" placeholder="">
